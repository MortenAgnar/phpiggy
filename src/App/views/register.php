  ...
  <form method="POST" class="grid grid-cols-1 gap-6"> 
    ...
    <label class="block">
      ...
      >
        ...
        <option value="Canada">Canada <?php echo $oldFormData['country'] === 'Canada' ? 'selcted' : ''; ?> </option>
        <option value="Mexico">Mexico <?php echo $oldFormData['country'] === 'Mexico' ? 'selcted' : ''; ?> </option>
